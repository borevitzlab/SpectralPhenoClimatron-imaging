...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   [Added by TB]
%   'ImCenter'     x,y coordinates of the center point to apply unwarp.                 If omitted, image center is used.
%                           INPUT AS: ...,'center',(x,y)
%                           Where x,y are coordinates of the center of the
%                           image for the unwarp.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Class Support
%   -------------
...
if ndims(I) == 3
     for i=1:3
       I2(:,:,i) = imdistcorrect(I(:,:,i),k, imcenter);
     end
elseif ismatrix(I)
...
% Nested function that perfoms the transformation
    ...
    [ut, vt] = doTransformation ( xt, yt, k, center, ...
                    p.Results.ftype, p.Results.bordertype );
